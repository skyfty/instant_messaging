...
import 'package:instant_messaging/src/pages/privacy/privacy_webview.dart';
import 'package:instant_messaging/src/provider/theme.dart';
import 'package:instant_messaging/src/routes.dart';
import 'package:instant_messaging/utils/GenerateUserSig.dart';
import 'package:instant_messaging/utils/commonUtils.dart';
          ...
          content: Text.rich(
            TextSpan(
                ...
                children: [
                  TextSpan(
                    text: TIM_t(
                        "欢迎使用即时通信 IM，为保护您的个人信息安全，我们更新了《隐私政策》，主要完善了收集用户信息的具体内容和目的、增加了第三方SDK使用等方面的内容。"),
                  ),
                  const TextSpan(
                    text: "\n",
                  ),
